...
set_time_limit(0);
error_reporting(0);
$version = "2.7"; //DON'T TOUCH THIS !
$website = "http://insertyourdomainhere.com"; //Use http or https
$title = "LINE sUx"; //U can change this
$norand = rand();
...
function get_theme_url($d){
	...
	$get__some__beer = ambilKata($xhtp,$kode_1."/".$kode_2."/".$kode_3."/".$code."/",'/');
...
<title><?if(!$theme_info[3]){echo $title;}else{echo $theme_info[3];}?></title>
...
<script>
function submit(){
	var redir = "<?echo $website;?>?url="+document.getElementById("url").value;;
